...
const unsigned long tiempoEspera = 130000;  // 130 segundos en milisegundos

//Definimos los tiempos de espera de los colores principales.
const unsigned long tiempoRojo = 30000;
  ...
  if (flag1 && flag2) {
    if (mA1 >= promRojoON) {
      ...
      if (envRojo == false) {
        ...
        //enviamos tiempo de encendido en lora
        String myMessage = "Lampara roja encendida";
        main_lora_send(myMessage)
      ...
      if (tiempoTranscurrido >= tiempoRojo) {
        ...
        //enviamos tiempo de encendido en lora
        String myMessage = "Lampara roja Apagada";
        main_lora_send(myMessage)
...
void main_lora_send(String message){
